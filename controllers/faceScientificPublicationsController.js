...
class faceScientificPublicationsController {
    getOnParams = async (params) => {
        return await tblFaceScientificPublications.findAll({
            where: params,
        });
    }
    ...
    create = async (req, res, next) => {
        ...
        try {
            const recCreated = await Crud.create(req, null, next, tblFaceScientificPublications);
    ...
    update = async (req, res, next) => {
        const updateRec = await Crud.update(req, null, next, tblFaceScientificPublications);
        try {
